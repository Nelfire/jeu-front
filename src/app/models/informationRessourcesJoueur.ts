export class InformationRessourcesJoueur {
    constructor(public apportPierreSeconde: number,
        ...
        public quantiteMaximaleStockagePierre: number,
        public quantiteMaximaleStockageBois: number,
        public quantiteMaximaleStockageOr: number,
        public quantiteMaximaleStockageNourriture: number,
